...
namespace RohimToolBox.Forms.DiffSets
{
    partial class frmDiffSets
    {
      ...
      this.txtLeft = new ScintillaNET.Scintilla();
      this.txtRight = new ScintillaNET.Scintilla();
      ...
      this.ResumeLayout(false);
        ...
        private ScintillaNET.Scintilla txtLeft;
        private ScintillaNET.Scintilla txtRight;
    }
}